...
2. Choose environment and create backend config for the main stack:
...
Edit `envs/${ENV}/backend.hcl` with real values from step 1 (bucket/table/region/key).
